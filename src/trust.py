...
FAQ = [
    ...
    {
        "id": "sync",
        "q_pl": "Czy strona i Telegram mają ten sam postęp?",
        "a_pl": "Tak — po połączeniu kont (Konto → Połącz Telegram). Wspólne: checklista MOS, szkice PDF, kalendarz i aktywna subskrypcja.",
        "q_ru": "Сайт и Telegram — один прогресс?",
        "a_ru": "Да — после связки аккаунтов (Konto → Связать Telegram). Общее: чеклист MOS, черновики PDF, календарь и активная подписка.",
        "q_en": "Do the website and Telegram share progress?",
        "a_en": "Yes — after you link accounts (Account → Link Telegram). Shared: MOS checklist, PDF drafts, calendar, and an active subscription.",
        "q_ua": "Сайт і Telegram мають один прогрес?",
        "a_ua": "Так — після звʼязку акаунтів (Konto → Повʼязати Telegram). Спільне: чекліст MOS, чернетки PDF, календар і активна підписка.",
    },
    {
        "id": "mos_only",
