...
READY_STEPS = [
    {
        ...
        "action_ru": "Сделай PESEL (или meldunek)",
        "action_en": "Get a PESEL (or address registration)",
        "action_ua": "Зроби PESEL (або meldunek)",
        ...
        "time_ru": "~1 визит в urząd / gminę",
        "time_en": "~1 visit to the commune office",
        "time_ua": "~1 візит до urzędu / gminy",
    ...
    },
    {
        ...
        "action_ru": "Запиши дату конца легального pobytu",
        "action_en": "Save your legal stay end date",
        "action_ua": "Запиши дату кінця легального pobytu",
    ...
    },
    {
        ...
        "hint_ru": "Фото в цифровом формате по требованиям urzędu.",
        "hint_en": "A digital photo matching office requirements.",
        "hint_ua": "Фото в цифровому форматі за вимогами urzędu.",
    ...
    },
    {
        ...
        "ua": "Знаю про opłatę skarbową + 100 zł за карту",
        "action_pl": "Sprawdź opłaty (skarbowa + 100 zł karta)",
        "action_ru": "Проверь пошлины (skarbowa + 100 zł карта)",
        "action_en": "Check the fees (stamp duty + 100 zł card)",
        "action_ua": "Перевір збори (skarbowa + 100 zł карта)",
    ...
    },
    {
        ...
        "action_ru": "Узнай, кто e-подпишет załącznik (email)",
        "action_en": "Confirm who will e-sign the attachment (email)",
        "action_ua": "Дізнайся, хто e-підпише załącznik (email)",
...
def next_action(done: dict[str, bool] | None, lang: str = "pl") -> dict:
    ...
    return {
        ...
        "title": {
            ...
            "ru": "Открой официальный MOS и подай wniosek",
            "en": "Open official MOS and file",
            "ua": "Відкрий офіційний MOS і подай wniosek",
        }[lang],
        "checklist_title": {
            "pl": "Wszystko gotowe",
            "ru": "Всё готово",
