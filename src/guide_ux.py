...
OFFICIAL_LINKS = [
    ...
    },
    {
        ...
        "pl": "Profil Zaufany",
        "ru": "Profil Zaufany (доверенный профиль)",
        "en": "Trusted profile",
        "ua": "Profil Zaufany (довірений профіль)",
    },
    {
        "id": "info",
        "url": MOS_INFO_URL,
...
_COPY = {
    "pl": {
        ...
        "whats_new_items": [
            "Teraz pokazuje jeden konkretny krok na dziś.",
            "Oficjalny pasek gov.pl + 3 etapy: przygotuj → sprawdź → złóż.",
            "Telegram i strona mogą mieć wspólny postęp MOS i szkice PDF.",
        ],
        "whats_new_dismiss": "OK, dzięki",
        "acc_session_title": "Sesja",
        "acc_session_hint": "Zaloguj się, żeby zapisać postęp na innych urządzeniach.",
        "acc_billing_title": "Płatności",
        "acc_tg_title": "Telegram ↔ strona",
        "acc_tg_hint": "Jeden postęp: MOS i szkice formularzy. Zaloguj się, wygeneruj kod, otwórz bota.",
        "acc_login": "Zaloguj",
        "acc_register": "Załóż konto",
        "load_error": "Nie udało się wczytać. Sprawdź sieć.",
        "retry": "Spróbuj ponownie",
        "docs_loading": "Ładowanie dokumentów…",
        "docs_empty": "Brak dokumentów na liście.",
        "mos_loading": "Ładowanie następnego kroku…",
    },
    "ru": {
        "official_kicker": "Официальный путь",
        "official_note": "WniosekPL помогает подготовиться. Заявление подаёшь только на mos.cudzoziemcy.gov.pl — портал UdSC.",
        ...
        "path": [
            ...
            },
            {
                "id": "file",
                "title": "3. Подай в MOS",
                "body": "Открой официальный портал, отправь заявление и скачай UPO.",
            },
        ],
        "how_title": "Как пользоваться профилем",
        "how_items": [
            "Вкладка «Сейчас» — только твой следующий шаг.",
            "«Документы» — заполни PDF (поля сохраняются сами).",
            "«Аккаунт» — вход, Telegram и оплата.",
        ],
        "how_dismiss": "Понятно",
        ...
        "landing_path_title": "Официальный путь к заявлению",
        "landing_path_sub": "Сначала подготовка у нас — подача только в MOS на gov.pl.",
        "whats_new_title": "Что нового",
        "whats_new_items": [
            "«Сейчас» показывает один конкретный шаг на сегодня.",
            "Официальная полоса gov.pl + 3 этапа: подготовь → проверь → подай.",
            "Telegram и сайт могут делить прогресс MOS и черновики PDF.",
        ],
        "whats_new_dismiss": "Ок, спасибо",
        "acc_session_title": "Сессия",
        "acc_session_hint": "Войди, чтобы сохранить прогресс на других устройствах.",
        "acc_billing_title": "Оплата",
        "acc_tg_title": "Telegram ↔ сайт",
        "acc_tg_hint": "Один прогресс: MOS и черновики форм. Войди, получи код, открой бота.",
        "acc_login": "Войти",
        "acc_register": "Создать аккаунт",
        "load_error": "Не удалось загрузить. Проверь интернет.",
        "retry": "Попробовать снова",
        "docs_loading": "Загрузка документов…",
        "docs_empty": "Список документов пуст.",
        "mos_loading": "Загрузка следующего шага…",
    },
    "en": {
        ...
        "whats_new_items": [
            "Now shows one concrete step for today.",
            "Official gov.pl bar + 3 stages: prepare → review → file.",
            "Telegram and the site can share MOS progress and PDF drafts.",
        ],
        "whats_new_dismiss": "OK, thanks",
        "acc_session_title": "Session",
        "acc_session_hint": "Log in to save progress across devices.",
        "acc_billing_title": "Billing",
        "acc_tg_title": "Telegram ↔ site",
        "acc_tg_hint": "One progress: MOS and form drafts. Log in, get a code, open the bot.",
        "acc_login": "Log in",
        "acc_register": "Create account",
        "load_error": "Could not load. Check your connection.",
        "retry": "Try again",
        "docs_loading": "Loading documents…",
        "docs_empty": "No documents on the list.",
        "mos_loading": "Loading your next step…",
    },
    "ua": {
        "official_kicker": "Офіційний шлях",
        "official_note": "WniosekPL допомагає підготуватися. Заяву подаєш лише на mos.cudzoziemcy.gov.pl — портал UdSC.",
        ...
        "path": [
            ...
            },
            {
                "id": "file",
                "title": "3. Подай у MOS",
                "body": "Відкрий офіційний портал, надішли заяву і завантаж UPO.",
            },
        ],
        "how_title": "Як користуватися профілем",
        "how_items": [
            "Вкладка «Зараз» — лише твій наступний крок.",
            "«Документи» — заповни PDF (поля зберігаються самі).",
            "«Акаунт» — вхід, Telegram і оплата.",
        ],
        ...
        "landing_path_title": "Офіційний шлях до заяви",
        "landing_path_sub": "Спочатку підготовка в нас — подання лише в MOS на gov.pl.",
        "whats_new_title": "Що нового",
        "whats_new_items": [
            "«Зараз» показує один конкретний крок на сьогодні.",
            "Офіційна смуга gov.pl + 3 етапи: підготуй → перевір → подай.",
            "Telegram і сайт можуть ділити прогрес MOS і чернетки PDF.",
        ],
        "whats_new_dismiss": "Ок, дякую",
        "acc_session_title": "Сесія",
        "acc_session_hint": "Увійди, щоб зберегти прогрес на інших пристроях.",
        "acc_billing_title": "Оплата",
        "acc_tg_title": "Telegram ↔ сайт",
        "acc_tg_hint": "Один прогрес: MOS і чернетки форм. Увійди, отримай код, відкрий бота.",
        "acc_login": "Увійти",
        "acc_register": "Створити акаунт",
        "load_error": "Не вдалося завантажити. Перевір інтернет.",
        "retry": "Спробувати знову",
        "docs_loading": "Завантаження документів…",
        "docs_empty": "Список документів порожній.",
        "mos_loading": "Завантаження наступного кроку…",
    },
}
